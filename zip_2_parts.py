...
exclude = {'node_modules', '.venv', 'venv', '__pycache__', 'dist', '.git'}
...
# 2. Backend
backend_src = r'C:\Users\peera\Desktop\AntigravityProject\TeacherHub'
backend_zip = r'C:\Users\peera\Desktop\TeacherHub_Backend_v1.2.4.zip'
create_zip(backend_src, backend_zip, exclude)
